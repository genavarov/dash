...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Bash related functionality
...
/*
    ...
    allow endless transaction that would bloat Bash and make it unusable. To
