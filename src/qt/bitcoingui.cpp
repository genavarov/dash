    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Bash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bash: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Bash Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bash Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bash addresses"));
    ...
    openAction->setStatusTip(tr("Open a bash: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bash Core help message to get a list with possible Bash Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Bash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bash network", "", count));
    } else {
...
{
    QString strTitle = tr("Bash Core"); // default title
