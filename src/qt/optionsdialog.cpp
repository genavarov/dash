    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BASH-light"), QVariant("light"));
    ui->theme->addItem(QString("BASH-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BASH-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BASH-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BASH-traditional"), QVariant("trad"));
