    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Bash Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Bash Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bash-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Bash in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BASH, 0.1 BASH, 1 BASH and 10 BASH -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://bashpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://bashpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Bash Core is shutting down...") + "<br /><br />" +
