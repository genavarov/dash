...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total bash balance of the wallet\n"
            "  \"privatesend_balance\": xxxxxx, (numeric) the anonymized bash balance of the wallet\n"
...
UniValue debug(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "bash|privatesend|instantsend|masternode|spork|keepass|mnpayments|gobject )\n"
            "Change debug category on the fly. Specify single category or use comma to specify many.\n"
            "\nExamples:\n"
            + HelpExampleCli("debug", "bash")
            + HelpExampleRpc("debug", "bash,net")
        );
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"bashaddress\"\n"
            "\nReturn information about the given bash address.\n"
            "\nArguments:\n"
            "1. \"bashaddress\"     (string, required) The bash address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"bashaddress\", (string) The bash address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"1NPENxRWjPo1WVQCsnN6L3ARxfkdK7WAeT\"")
            + HelpExampleRpc("validateaddress", "\"1NPENxRWjPo1WVQCsnN6L3ARxfkdK7WAeT\"")
        );
...
#ifdef ENABLE_WALLET
        // Case 1: Bash address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are bash addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) bash address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"bashaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"bashaddress\"  (string, required) The bash address to use for the signature.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"1NPENxRWjPo1WVQCsnN6L3ARxfkdK7WAeT\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"1NPENxRWjPo1WVQCsnN6L3ARxfkdK7WAeT\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"1NPENxRWjPo1WVQCsnN6L3ARxfkdK7WAeT\"]}")
        );
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"1NPENxRWjPo1WVQCsnN6L3ARxfkdK7WAeT\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"1NPENxRWjPo1WVQCsnN6L3ARxfkdK7WAeT\"]}")
        );
...
UniValue getaddressdeltas(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1 || !params[0].isObject())
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"1NPENxRWjPo1WVQCsnN6L3ARxfkdK7WAeT\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"1NPENxRWjPo1WVQCsnN6L3ARxfkdK7WAeT\"]}")
        );
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"1NPENxRWjPo1WVQCsnN6L3ARxfkdK7WAeT\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"1NPENxRWjPo1WVQCsnN6L3ARxfkdK7WAeT\"]}")
        );
...
UniValue getaddresstxids(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"1NPENxRWjPo1WVQCsnN6L3ARxfkdK7WAeT\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"1NPENxRWjPo1WVQCsnN6L3ARxfkdK7WAeT\"]}")
        );
