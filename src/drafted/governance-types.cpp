...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BashNetwork") type = BashNetwork;
    if(strType == "BashNetworkVariable") type = BashNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BashNetwork) s = "BashNetwork";
    if(type == BashNetworkVariable) s = "BashNetworkVariable";
