...
Bash Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 8899.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 8898 for connections and services them.
...
However, in open source software such as Bash Core, where everyone uses
...
pay attention to for reviewers of Bash Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Bash Core uses tinyformat, which is type safe. Leave them out to avoid confusion
