...
Only requiring some minor changes is bash.cpp.
...
Changes to bash.cpp
----------------------
bash.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
