...
This mechanism has been integrated into Bitcore-Node-Bash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bashpay/insight-api-bash#web-socket-api](https://github.com/bashpay/insight-api-bash#web-socket-api)
* API: [https://github.com/bashpay/insight-api-bash#instantsend-transactions](https://github.com/bashpay/insight-api-bash#instantsend-transactions)
...
By default, the Bash Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bash Core daemon:
